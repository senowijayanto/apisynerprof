      ...
      <form class="form-horizontal" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="category">
                ...
                <option value="1" <?php echo ($product->category == 1 ? 'selected' : '');?>>Nutrition</option>
                <option value="2" <?php echo ($product->category == 2 ? 'selected' : '');?>>Body Care</option>
              </select>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="textarea" name="description" placeholder="Place some description here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $product->description;?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="inputBenefits" class="col-sm-2 control-label">Benefits</label>
            <div class="col-sm-10">
              <textarea class="textarea" name="benefits" placeholder="Place some benefits here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $product->benefits;?></textarea>
            </div>
          </div>
          <div class="form-group">
